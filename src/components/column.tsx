...
export const Column: React.FC<ColumnProps> = ({ name, tasks, subTasks }) => {
...
export const Task: React.FC<TaskProps> = ({ task, subTasks, controls }) => {
  const completedSubTasks = subTasks.filter((subTask) => subTask.isCompleted)

  return (
    <div className="relative h-[88px] w-full rounded-[8px] bg-white px-4 py-[23px] shadow dark:bg-dark-grey">
      <button
